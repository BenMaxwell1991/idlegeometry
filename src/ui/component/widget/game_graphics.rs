...
use eframe::egui::{Color32, Id, Key, Sense, Ui, Vec2, Widget};
...
impl GameGraphics {
    pub fn new(game_data: Arc<GameData>, id_salt: impl Hash) -> Self {
        if game_data.get_field::<Pos2>("player_position").is_none() {
...
impl Widget for GameGraphics {
    fn ui(self, ui: &mut Ui) -> eframe::egui::Response {
        ...
        let player_position = self.game_data.get_field::<Pos2>("player_position").unwrap_or(Pos2::new(100.0, 100.0)).add(rect.min.to_vec2());
