...
use crate::game::resources::resource::DEFAULT_STATS;
...
pub fn create_enemy_at_point(handle: &str) -> Unit {
    ...
    Unit::new(UnitType::Enemy, UnitShape::new(20 * FIXED_POINT_SCALE, 20 * FIXED_POINT_SCALE), 30 * FIXED_POINT_SCALE, DEFAULT_STATS.clone(), animation)
}